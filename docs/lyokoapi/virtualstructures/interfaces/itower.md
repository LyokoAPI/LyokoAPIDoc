...
\
&#xNAN;_&#x48;int: If the implementation is APITower, it's not guaranteed that the Sector and the VirtualWorld have other data besides the tower. See_ [_APITower_](../apitower.md) _for more information._
