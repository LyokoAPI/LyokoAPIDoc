...
Calling this method will disable all plugins. _note: there's no guarantee that a plugin will actually be disabled._<br>

### EnableAll()

Calling this method will enable all plugins. _note: there's no guarantee that a plugin will actually be enabled._ <br>
